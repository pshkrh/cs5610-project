...
export const sendmoney = (id, money) => {
  return async (dispatch) => {
    await axios
      .post("/api/admin/sendmoney", { id, money })
      .then((res) => {
        dispatch({
...
export const creategarbage = (garbage) => {
  ...
  return async (dispatch) => {
    await axios
      .post("/api/admin/creategarbage", { garbage })
      .then((res) => {
        dispatch({
...
export const editgarbage = (garbage) => {
  return async (dispatch) => {
    await axios
      .post("/api/admin/editgarbage", { garbage })
      .then((res) => {
        dispatch({
...
export const deletegarbage = (garbage) => {
  return async (dispatch) => {
    await axios
      .post("/api/admin/deletegarbage", { garbage })
      .then((res) => {
        dispatch({

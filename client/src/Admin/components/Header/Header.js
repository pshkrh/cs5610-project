    ...
    return (
        <div>
            ...
            <div className={classes.container}>
                ...
                <Link to="/admin/dashboard" className={classes.brandname}><h3 >WasteDeal</h3><h6 style={{ marginTop: "-10px" }}>Admin</h6></Link>
                ...
                <Link to="/admin/addgarbage" className={classes.addgarbage} style={addgarbagecolor}><h4 >Add_Scrap</h4></Link>

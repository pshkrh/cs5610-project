    ...
    let card = (
        <div className={classes.cards}>
            ...
            <div className={classes.card}>
                ...
                <span className={classes.amount}>lb {props.totalGarbageWeight}</span><br />
                <span className={classes.title}>Total Scrap</span>
            </div>
            <div className={classes.card}>
        ...
        <div className={classes.container1}>
            ...
            <div className={classes.graphcard}>
                <table width="100%">
                    ...
                    <tr>
                        <td><b>Paper</b></td>
                        <td>{props.Paper.paperweight} lb</td>
                        <td>&#x24; {props.Paper.paperspend}</td>
                    </tr>
                    <tr>
                        <td><b>Plastic</b></td>
                        <td>{props.Plastic.plasticweight} lb</td>
                        <td>&#x24; {props.Plastic.plasticspend}</td>
                    </tr>
                    <tr>
                        <td><b>Metal</b></td>
                        <td>{props.Metal.metalweight} lb</td>
                        <td>&#x24; {props.Metal.metalspend}</td>
                    </tr>
                    <tr>
                        <td><b>E-Waste</b></td>
                        <td>{props.Ewaste.ewasteweight} lb</td>
                        <td>&#x24; {props.Ewaste.ewastespend}</td>
                    </tr>
                    <tr>
                        <td><b>Other</b></td>
                        <td>{props.Other.otherweight} lb</td>

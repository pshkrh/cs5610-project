    ...
    <div>
      {displaygc ? (
        <div className={classes.container}>
          <div className={classes.combine}>
            <span>
              {
                <button className={classes.change} onClick={(e) => onaddgc(e)}>
            ...
            <span>
              {props.gcs.length !== 0 ? (
                <h2 className={classes.title}>Garbage Collectors</h2>
              ) : (
                <h3 className={classes.title} style={{ marginBottom: "30px" }}>
                  You have not any Garbage Collector
                </h3>
              )}
            </span>
          </div>
            ...
            <div key={gc._id}>
              <div className={classes.details}>
                <div>
                  ...
                  <br />
                  <span>
                    {format(new Date(gc.createdAt), "dd-MM-yyyy   hh:mm:ss a")}
                  </span>
                </div>
                <div>
                  <span style={{ fontWeight: "bold" }}>
              ...
              <div className={classes.order} key={gc._id}>
                <div className={classes.card}>
                  ...
                  <br />
                  <span>
                    <span style={{ fontWeight: "bold" }}>WalletAmount : </span>
                    {gc.walletAmount} <b>&#x24;</b>
                  </span>
                </div>
                <div className={classes.card}>
                  <div className={classes.card2}>
                    <button
                      className={classes.change2}
                      onClick={(e) => onsendmoney(e, gc._id)}
                    >
                      Send Money (&#x24;)
                    </button>
                    <button
                      className={classes.cancel}
                      onClick={(e) => oncancel(e, gc._id)}
                    >
      ...
      {displaysm ? (
        <div className={classes.redeemamt}>
          ...
          {
            <span style={{ color: "red", marginLeft: "20px" }}>
              {state.amountError ? state.amountError : null}
            </span>
          }
          <input
            type="number"
            ...
            required
            onChange={(e) =>
              setstate({ ...state, inputamount: e.target.value })
            }
          ...
          <button
            ...
            onClick={(e) => onaddmoneycancel(e)}
          >
            Cancel
          </button>
          <button
            className={classes.btnsuccess}
            onClick={(e) => onaddmoneysuccess(e)}
          >
            Send
          </button>
        </div>

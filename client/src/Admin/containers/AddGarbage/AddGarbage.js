...
const AddGarbage = (props) => {
  ...
  let addform = (
    <div className={classes.addform}>
      ...
      <select
        ...
        value={creategarbage.category}
        onChange={(e) => {
          setcg({ ...creategarbage, category: e.target.value });
        }}
      >
      ...
      <span>
        {creategarbage.newGError.scname ? (
          <span style={{ color: "red", marginLeft: "25px" }}>
            {creategarbage.newGError.scname}
          </span>
        ) : null}
      ...
      <input
        ...
        value={creategarbage.newGarbageName}
        onChange={(e) => {
          setcg({ ...creategarbage, newGarbageName: e.target.value });
        }}
        required
      />
      <label>
        <b>Price of garbage</b>
      </label>
      <span>
        {creategarbage.newGError.grate ? (
          <span style={{ color: "red", marginLeft: "25px" }}>
            {creategarbage.newGError.grate}
          </span>
        ) : null}
      ...
      <input
        type="number"
        placeholder="Enter garbage price"
        value={creategarbage.newGarbageRate}
        onChange={(e) => {
          setcg({ ...creategarbage, newGarbageRate: e.target.value });
        }}
        required
      />
      <label>
      ...
      <select
        className={classes.catg}
        value={creategarbage.newGarbageQnt}
        onChange={(e) => {
          setcg({ ...creategarbage, newGarbageQnt: e.target.value });
        }}
      >
      ...
      {creategarbage.newGarbageQnt === "piece" ? (
        <div>
          <label>
            <b>Default Weight</b>
          </label>
          <span>
            {creategarbage.newGError.dwgt ? (
              <span style={{ color: "red", marginLeft: "25px" }}>
                {creategarbage.newGError.dwgt}
              </span>
            ) : null}
          ...
          <input
            type="number"
            placeholder="Enter default weight in lb"
            value={creategarbage.defaultWeight}
            onChange={(e) => {
              setcg({ ...creategarbage, defaultWeight: e.target.value });
            }}
            required
          />
        </div>
  ...
  let modifyRateform = (
    <div className={classes.addform}>
      ...
      <span style={{ color: "red", marginLeft: "25px" }}>
        {editform.editGError?.cname ? editform.editGError.cname : null}
      </span>
      <select
        className={classes.catg}
      ...
      <span style={{ color: "red", marginLeft: "25px" }}>
        {editform.editGError?.scname ? editform.editGError.scname : null}
      </span>
      <select
        className={classes.catg}
        onChange={(e) =>
          seteditform({
            ...editform,
            editGarbageRate: e.target.value.split("|")[0],
            editGarbageName: e.target.value.split("|")[1],
          })
        }
      >
        <option value="sg">Select Garbage</option>
        {props.garbage[editform.subcatagoryNum]?.subcatagory.map((sc) => {
          return <option value={`${sc.rate}|${sc.name}`}>{sc.name}</option>;
        })}
      </select>
      <label>
        <b>Price of garbage (&#x24;)</b>
      ...
      <span style={{ color: "red", marginLeft: "25px" }}>
        {editform.editGError?.grate ? editform.editGError.grate : null}
      </span>
      <input
        type="number"
        placeholder="Enter garbage price"
        value={editform.editGarbageRate}
        onChange={(e) => {
          seteditform({ ...editform, editGarbageRate: e.target.value });
        }}
        required
      />
      <div style={{ display: "flex" }}>
  ...
  let deleteGarbageForm = (
    <div className={classes.addform}>
      ...
      <span style={{ color: "red", marginLeft: "25px" }}>
        {deleteform.deleteGError?.cname ? deleteform.deleteGError.cname : null}
      </span>
      <select
        className={classes.catg}
      ...
      <select
        className={classes.catg}
        onChange={(e) =>
          setdeleteform({ ...deleteform, deleteGarbageName: e.target.value })
        }
      >
        <option value="sg">Select Garbage</option>
          ...
          return (
            <div className={classes.card}>
              <table style={{ border: "none" }}>
                <tr>
                  <th colSpan="2" style={{ width: "214px" }}>
                    {gar.category}
                  </th>
                </tr>

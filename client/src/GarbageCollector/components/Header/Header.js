    ...
    return (
        <div>
            <div className={classes.container}>
                ...
                <Link to="/gc/dashboard" className={classes.brandname}><h3>WasteDeal</h3><h6 style={{ marginTop: "-10px", fontSize: "12px", color: "#476E4B" }}>Garbage Collector({props.gc.city})</h6></Link>

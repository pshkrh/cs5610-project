        ...
        <footer className={classes.container}>
            <div className={classes.info}>
                <div className={classes.container1}>
                    ...
                    <h5 className={classes.brandname}>WasteDeal</h5>
                ...
                <div className={classes.container2}>
                    ...
                    <p className={classes.links1} style={{ color: "#444", fontWeight: "bold" }}>
                        <img src={home} height="25px" width="30px" style={{ borderRadius: "5px" }} alt="home" />1 Washington Sq,   <br /><span style={{ margin: "10px 0 0 35px" }}> San Jose, CA 95192,</span></p>
                    <p className={classes.links2} style={{ color: "#444", fontWeight: "bold" }}>
                        <img src={email} height="25px" width="25px" style={{ borderRadius: "5px" }} alt="email" /> help@wastedeal.com </p>
                    <p className={classes.links3} style={{ color: "#444", fontWeight: "bold" }}>
                        <img src={call} height="25px" width="25px" style={{ borderRadius: "5px" }} alt="call" />  +1 408 924 1000</p>
                </div>
            ...
            <div className={classes.container4}>
                <h5>&copy; {new Date().getFullYear()} Copyright: WasteDeal</h5>
            </div>
        </footer>

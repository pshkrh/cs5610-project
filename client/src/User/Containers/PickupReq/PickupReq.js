...
class PickupReq extends Component {
  ...
  onpaperselect = (e, item) => {
    ...
    if (selectedscrapp[0].paper.some((scrap) => scrap.name === item.name)) {
      selectedscrapp[0].paper = selectedscrapp[0].paper.filter(
        (scrap) => scrap.name !== item.name
      );
      e.target.style.backgroundColor = "whitesmoke";
    } else {
      if (item.quntityin === "piece") {
        selectedscrapp[0].paper.push({
          name: item.name,
          quantityin: item.quntityin,
          rate: item.rate,
  ...
  onplasticselect = (e, item) => {
    ...
    if (selectedscrapp[1].plastic.some((scrap) => scrap.name === item.name)) {
      selectedscrapp[1].plastic = selectedscrapp[1].plastic.filter(
        (scrap) => scrap.name !== item.name
      );
      e.target.style.backgroundColor = "whitesmoke";
    } else {
      if (item.quntityin === "piece") {
        selectedscrapp[1].plastic.push({
          name: item.name,
          quantityin: item.quntityin,
          rate: item.rate,
          defaultWeight: item.defaultWeight,
  ...
  onmetalselect = (e, item) => {
    ...
    if (selectedscrapp[2].metal.some((scrap) => scrap.name === item.name)) {
      selectedscrapp[2].metal = selectedscrapp[2].metal.filter(
        (scrap) => scrap.name !== item.name
      );
      e.target.style.backgroundColor = "whitesmoke";
    } else {
      if (item.quntityin === "piece") {
        selectedscrapp[2].metal.push({
          name: item.name,
          quantityin: item.quntityin,
          rate: item.rate,
          defaultWeight: item.defaultWeight,
  ...
  onewasteselect = (e, item) => {
    ...
    if (selectedscrapp[3].ewaste.some((scrap) => scrap.name === item.name)) {
      selectedscrapp[3].ewaste = selectedscrapp[3].ewaste.filter(
        (scrap) => scrap.name !== item.name
      );
      e.target.style.backgroundColor = "whitesmoke";
    } else {
      if (item.quntityin === "piece") {
        selectedscrapp[3].ewaste.push({
          name: item.name,
          quantityin: item.quntityin,
          rate: item.rate,
          defaultWeight: item.defaultWeight,
  ...
  onotherselect = (e, item) => {
    ...
    if (selectedscrapp[4].other.some((scrap) => scrap.name === item.name)) {
      selectedscrapp[4].other = selectedscrapp[4].other.filter(
        (scrap) => scrap.name !== item.name
      );
      e.target.style.backgroundColor = "whitesmoke";
    } else {
      if (item.quntityin === "piece") {
        selectedscrapp[4].other.push({
          name: item.name,
          quantityin: item.quntityin,
          rate: item.rate,
          defaultWeight: item.defaultWeight,
  ...
  oncontinue = (e) => {
    ...
    let isvalid = true;
    if (
      this.state.selectedscrap[0].paper.length === 0 &&
      this.state.selectedscrap[1].plastic.length === 0 &&
      this.state.selectedscrap[2].metal.length === 0 &&
      this.state.selectedscrap[3].ewaste.length === 0 &&
      this.state.selectedscrap[4].other.length === 0
    ) {
      isvalid = false;
    }
    if (!isvalid) {
      this.setState({
        error: "You have not choose any items..please select items first",
      });
    } else {
        ...
        <>
          <div className={classes.selectgarbage}>
            <div className={classes.userinfo}>
              ...
              <h6
                style={{ color: "#444", fontWeight: "bold", fontSize: "20px" }}
              >
            ...
            <div className={classes.items}>
              <div
                ...
                onClick={(e) => this.paperclick(e)}
                style={{
                  backgroundColor: this.state.papersel ? "#dff0d8" : null,
                }}
              >
                {this.state.papersel ? (
                  <img
                  ...
                  <img className={classes.right1} src={right1} alt="right1" />
                )}
              ...
              <div
                className={classes.item}
                onClick={(e) => this.plasticclick(e)}
                style={{
                  backgroundColor: this.state.plasticsel ? "#dff0d8" : null,
                }}
              >
              ...
              <div
                className={classes.item}
                onClick={(e) => this.metalclick(e)}
                style={{
                  backgroundColor: this.state.metalsel ? "#dff0d8" : null,
                }}
              >
                {this.state.metalsel ? (
                  <img
              ...
              <div
                className={classes.item}
                onClick={(e) => this.ewasteclick(e)}
                style={{
                  backgroundColor: this.state.ewastesel ? "#dff0d8" : null,
                }}
              >
              ...
              <div
                className={classes.item}
                onClick={(e) => this.otherclick(e)}
                style={{
                  backgroundColor: this.state.othersel ? "#dff0d8" : null,
                }}
              >
                {this.state.othersel ? (
                  <img
                ...
                <>
                  ...
                  <div className={classes.paperinfo}>
                    {this.props.garbage[0].subcatagory.map((item) => (
                      <div
                        className={classes.itemss}
                        key={item.name}
                        onClick={(e) => this.onpaperselect(e, item)}
                      >
                        {item.name}
                        <br />
                  ...
                  <div className={classes.paperinfo}>
                    {this.props.garbage[1].subcatagory.map((item) => (
                      <div
                        className={classes.itemss}
                        key={item.name}
                        onClick={(e) => this.onplasticselect(e, item)}
                      >
                        {item.name}
                        <br />
                        {item.rate}/{item.quntityin}
                  ...
                  <div className={classes.paperinfo}>
                    {this.props.garbage[2].subcatagory.map((item) => (
                      <div
                        className={classes.itemss}
                        key={item.name}
                        onClick={(e) => this.onmetalselect(e, item)}
                      >
                        {item.name}
                        <br />
                        {item.rate}/{item.quntityin}
                  ...
                  <div className={classes.paperinfo}>
                    {this.props.garbage[3].subcatagory.map((item) => (
                      <div
                        className={classes.itemss}
                        key={item.name}
                        onClick={(e) => this.onewasteselect(e, item)}
                      >
                        {item.name}
                        <br />
                        {item.rate}/{item.quntityin}
                  ...
                  <div className={classes.paperinfo}>
                    {this.props.garbage[4].subcatagory.map((item) => (
                      <div
                        className={classes.itemss}
                        key={item.name}
                        onClick={(e) => this.onotherselect(e, item)}
                      >
                        {item.name}
                        <br />
                        {item.rate}/{item.quntityin}
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(PickupReq)
);

                ...
                <>
                    <div className={classes.selectgarbage}>
                        <div className={classes.userinfo}>
                            <h5 style={{ color: "#6c757d", marginRight: "110px", fontSize: "25px" }}>Hello, {this.props.user.name}</h5>
                            <h6 style={{ color: "#444", fontWeight: "bold", fontSize: "20px" }}>What would you like to sell?</h6>
                        </div>
